				...
				<div class="row">
					<div class="col-md-6 offset-md-3">
						...
						<div class="form-group">
							...
							<input type="username" class="form-control form-control-sm" name="username" required value="<?php echo isset($username) ? $username : '' ?>">
							<small id="#msg"></small>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label class="label control-label">Xác nhận Password</label>
